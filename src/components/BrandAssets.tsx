      ...
      >
        <defs>
          <linearGradient id="logo-green-grad" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="#2e8b54" />
            <stop offset="100%" stopColor="#1F6B3D" />
          </linearGradient>
          <linearGradient id="logo-brown-grad" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="#a37350" />
      ...
      {variant !== 'symbol' && (
        <div className="flex flex-col leading-none text-left">
          <div className="flex items-baseline" id="logo_title_words">
            <span className="text-xl font-extrabold font-display tracking-tight text-[#1F6B3D] dark:text-[#2e8b54]">Shamba</span>
            <span className="text-xl font-bold font-display tracking-tight text-[#8B5E3C] dark:text-[#a37350]">Loop</span>
          </div>
...
export const VerifiedBadge: React.FC<VerifiedBadgeProps> = ({
  ...
  return (
    <span
      className={`inline-flex items-center gap-1.5 px-2 py-1 rounded-full text-[10px] font-bold border leading-none select-none ${config.colorClass} ${className}`}
