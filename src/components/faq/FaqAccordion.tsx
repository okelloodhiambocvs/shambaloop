      ...
      {items.map((item) => {
        ...
        return (
          <div key={item.id} className="py-4 sm:py-5">
            ...
            >
              <span className="text-xs sm:text-sm font-bold text-slate-900 dark:text-slate-100 group-hover:text-emerald-700 dark:group-hover:text-emerald-400 transition">
                {item.question}
              </span>
              <div
            ...
            {isOpen && (
              <div className="mt-3 pr-6 text-xs text-slate-600 dark:text-slate-300 leading-relaxed font-sans">
                {item.answer}
              </div>
            )}
          </div>
