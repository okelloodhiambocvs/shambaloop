...
import { Lock, Scale, CheckCircle2 } from 'lucide-react';
    ...
    <section className="py-16 bg-gradient-to-br from-emerald-950 via-[#123821] to-slate-950 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center space-y-4">
          ...
          <p className="text-sm sm:text-base md:text-lg text-emerald-100/80 leading-relaxed font-sans">
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-6 rounded-3xl bg-emerald-900/40 border border-emerald-700/40 backdrop-blur-sm space-y-3">
            ...
            <h3 className="text-lg sm:text-xl md:text-2xl font-bold font-display text-white">1. Milestone Locking</h3>
            <p className="text-sm sm:text-base md:text-lg text-emerald-200/80 leading-relaxed">
          ...
          <div className="p-6 rounded-3xl bg-emerald-900/40 border border-emerald-700/40 backdrop-blur-sm space-y-3">
            ...
            <h3 className="text-lg sm:text-xl md:text-2xl font-bold font-display text-white">2. Multi-Party Signoff</h3>
            <p className="text-sm sm:text-base md:text-lg text-emerald-200/80 leading-relaxed">
          ...
          <div className="p-6 rounded-3xl bg-emerald-900/40 border border-emerald-700/40 backdrop-blur-sm space-y-3">
            ...
            <h3 className="text-lg sm:text-xl md:text-2xl font-bold font-display text-white">3. Neutral Dispute Room</h3>
            <p className="text-sm sm:text-base md:text-lg text-emerald-200/80 leading-relaxed">
