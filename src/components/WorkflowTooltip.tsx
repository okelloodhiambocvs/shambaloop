...
import { HelpCircle, X, ChevronRight, Info, CheckCircle2 } from 'lucide-react';
    ...
    <div className={`relative inline-block ${className}`} ref={tooltipRef} id={`workflow_tooltip_${actionType}`}>
      <div className="flex items-center gap-1.5">
        <button
          ...
          className="text-emerald-600 hover:text-emerald-700 dark:text-emerald-400 dark:hover:text-emerald-300 p-1 rounded-full hover:bg-emerald-50 dark:hover:bg-slate-800 transition-colors cursor-pointer flex items-center gap-1 self-center"
        ...
        >
          ...
          <div className="flex justify-between items-start pb-2 mb-2 border-b border-slate-100 dark:border-slate-800">
            ...
            <button
              ...
              className="text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 p-0.5 rounded hover:bg-slate-100 dark:hover:bg-slate-800 transition cursor-pointer"
            >
          ...
          <div className="mt-1 pb-1 flex justify-end">
            <span className="text-[8px] text-slate-400 font-mono tracking-wider flex items-center gap-1">
              <CheckCircle2 className="w-2.5 h-2.5 text-emerald-500" /> Powered by ShambaLoop Trust
            </span>
          </div>
        </div>
      )}
